...
import { SendMsgOutAction, parseTrc20Transfer, toUnixTime } from "./utils"
...
describe('SmartContract', () => {
    ...
    it('should claim rewards 2', async () => {
        ...
        expect(claimResponse2.rewards).toBe( expectedRewards * (days) );
    });
    ...
    it('should claim rewards 3', async () => {
        ...
        //verify send token to message
        expect(claimResponse2.actions.length).toBe(1);
        expect(claimResponse2.rewards).toBe( expectedRewards * (days-1) );
    });
})
