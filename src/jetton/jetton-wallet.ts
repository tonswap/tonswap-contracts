...
import {parseActionsList, sliceToAddress267, toUnixTime, sliceToString, addressToSlice264, toDecimals} from "../utils";
...
//    = InternalMsgBody;
    ...
    async transfer(from: Address, to: Address, amount: BN, responseDestination: Address, customPayload?: Cell, forwardTonAmount?: BN, forwardPayload?: Cell) {
        ...
        messageBody.bits.writeCoins(forwardTonAmount || new BN(0));
    ...
    static async createFromMessage(code: Cell, data: Cell, initMessage: InternalMessage) {
        ...
        const initMessageResponse = await jettonWallet.sendInternalMessage(initMessage);
